...
local function setMenuVisible(id, visible, holdCurrent)
	if id and menus[id] then
		...
		--DrawSprite("menu_textures", "translate_bg_1a", 0.20, 0.2, 0.26, 0.35, 0.8, 000, 2, 2, 150, 1)
...
local function drawTitle()
	if menus[currentMenu] then
		...
		if HasStreamedTextureDictLoaded("menu_textures") then
			DrawSprite("menu_textures", "translate_bg_1a", x, y +0.1, 0.26, 0.35, 0.8, 000, 2, 2, 200, 1)
			DrawSprite("menu_textures", "translate_bg_1a", x, y, menus[currentMenu].width + .03, titleHeight, 0.0, 100, 2, 2, 255, 0)
		end
...
local function drawSubTitle()
	if menus[currentMenu] then
		...
		--DrawSprite("menu_textures", "translate_bg_1a", x, y+0.02, 0.26, 0.35, 0.8, 000, 2, 2, 150, 1)
...
local function drawButton(text, subText)
	...
	local multiplier = nil
			...
			--DrawSprite("menu_textures", "translate_bg_1a",  0.20, 0.2, 0.26, 0.35, 0.8, 000, 2, 2, 200, 1)
